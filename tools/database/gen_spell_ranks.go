...
func renderClassFile(db *sql.DB, pkg string, class dbc.DbcClass, namer *rankEnumNamer) ([]byte, error) {
	...
	fmt.Fprintf(&head, "// Code generated by tools/database/gen_spellranks. DO NOT EDIT.\n\n")
...
func formatValue(a generatedAmount) string {
	...
	case a.PeriodMs > 0:
		...
		out := fmt.Sprintf("shared.SpellRankPeriodic{Tick: %s, %s, TickLength: %s", tick, tail, millis(a.PeriodMs))
		if a.Ticks > 0 {
