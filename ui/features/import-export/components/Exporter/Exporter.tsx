		...
		<Dialog
			...
			footer={
				<>
					...
					{allowDownload && (
						<Button className="ml-2 w-48" onClick={() => downloadString(dataRef.current, downloadFileName, downloadMimeType)}>
			...
			<TextArea spellCheck={false} className="h-[60vh] w-full resize-none" data-testid="exporter-textarea" ref={textRef} defaultValue={data} />
		</Dialog>
	);
};
