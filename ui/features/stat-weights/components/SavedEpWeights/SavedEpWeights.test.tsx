...
const STORAGE_KEY = 'tbc-warrior-savedEPWeights';
...
const MIXED = new Stats().withStat(Stat.StatAgility, 4).withStat(Stat.StatMeleeCritRating, 1.75).withStat(Stat.StatStrength, 2);
