...
vi.mock('../../../../tracking/utils', () => ({ trackEvent: vi.fn(), trackPageView: (...args: unknown[]) => trackPageView(...args) }));
...
describe('ReforgePanel', () => {
	...
	it('disables the run button while a gem optimization run is in flight', () => {
