...
export const CritImmunityRow = ({ info, text }: { info: CritImmunityInfo; text: string }) => {
	const id = useId();
	return (
				...
				<Tooltip
					...
					content={
						<div>
							...
							{info.talents > 0 && <TooltipRow label={i18n.t('sidebar.character_stats.tooltip.talents')} value={`${info.talents.toFixed(2)}%`} />}
