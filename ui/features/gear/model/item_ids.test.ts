...
describe('getItemIdByItemType', () => {
	it('reads effectId on the enchant tab, not id', () => {
	...
	it('is null on a tab that carries no id', () => {
		expect(getItemIdByItemType('Nothing' as SelectorModalTabs, { id: 5 } as unknown as Item)).toBeNull();
	});
