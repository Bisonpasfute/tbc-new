...
vi.mock('@sim/proto/action_id/tooltip_data', () => ({ equippedItemWowheadTooltipData: () => Promise.resolve('') }));
...
const item = ({ gems = [], sockets = [] }: { gems?: Array<{ id: number; name: string } | null>; sockets?: number[] }) =>
	({
		gems,
		gemSockets: sockets,
