import type { CombatLog, DamageEffect, LogKind, Outcome, ParsedKind } from '@sim/proto/combat_log/types';
import { formattedTimestamp } from '@sim/proto/combat_log/types';
...
const TYPE_FILTERS = {
	...
	aura: { kinds: ['aura'] },
	buff: { kinds: ['aura'] },
	cast: { kinds: ['cast-began', 'cast-cancelled', 'cast-completed', 'cast', 'spell-queued', 'cast-failed', 'cast-pushback'] },
	delay: { kinds: ['auto-delay'] },
