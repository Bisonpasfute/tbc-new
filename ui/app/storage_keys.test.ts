...
const GOLDEN = {
	getSettingsStorageKey: '__tbc_new_balance_druid__currentSettings__',
	getSavedGearStorageKey: '__tbc_new_balance_druid__savedGear__',
	getSavedTalentsStorageKey: '__tbc_new_balance_druid__savedTalents__',
	getSavedRotationStorageKey: '__tbc_new_balance_druid__savedRotation__',
	getSavedSettingsStorageKey: '__tbc_new_balance_druid__savedSettings__',
	getSavedEPWeightsStorageKey: '__tbc_new_balance_druid__savedEPWeights__',
	getSavedEncounterStorageKey: 'sharedData__savedEncounter__',
	getPresetFilterStorageKey: '__tbc_new_balance_druid__presetFilters__',
};
...
describe('the storage keys SimHostObject builds', () => {
	...
	it('keeps the saved encounter key out of the spec prefix', () => {
		expect(SHARED_SAVED_ENCOUNTER_STORAGE_KEY.startsWith('__tbc_new')).toBe(false);
	});
});
