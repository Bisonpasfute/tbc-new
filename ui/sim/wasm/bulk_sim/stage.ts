...
const rerunConcurrentBulkSimStageAdditionalIterations = async (
	...
	// Hand the already-accumulated results to the batch runner so each candidate's progress
	// reports the merged average rather than the delta run's own average.
