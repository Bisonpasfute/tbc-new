...
export const resourceTextClass = (resourceType: ResourceType): string | undefined => RESOURCE_TEXT[resourceType];
...
export type ClassCssScheme = 'druid' | 'hunter' | 'mage' | 'paladin' | 'priest' | 'rogue' | 'shaman' | 'warlock' | 'warrior';
