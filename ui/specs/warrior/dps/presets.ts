...
export const P4_REFORGE_SETTINGS = ReforgeSettings.create({
...
export const P5_REFORGE_SETTINGS = ReforgeSettings.create({
...
export const P4_PRESET_BUILD_FURY = PresetUtils.makePresetBuild('Fury', {
	...
	reforgeSettings: P4_REFORGE_SETTINGS,
});
...
export const P5_PRESET_BUILD_FURY = PresetUtils.makePresetBuild('Fury', {
	...
	reforgeSettings: P5_REFORGE_SETTINGS,
});
