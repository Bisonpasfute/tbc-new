...
export default defineSpec<Spec.SpecHealerPriest>({
	spec: Spec.SpecHealerPriest,
	// Nothing is simulated, so the incoming-healing model stays off.
	enableHealing: false,

	className: 'healer-priest-sim-ui',
	...
	defaults: {
		...
		// Default talents.
		talents: Presets.CircleOfHealingTalents.data,
	...
	presets: {
		...
		talents: [Presets.CircleOfHealingTalents],
		// Preset rotations that the user can quickly select.
		rotations: [],
		// Preset gear configurations that the user can quickly select.
		gear: [Presets.PRERAID_PRESET, Presets.P3_T5_PRESET, Presets.P3_PRESET],
	},

	autoRotation: (_: Player<Spec.SpecHealerPriest>): APLRotation => {
